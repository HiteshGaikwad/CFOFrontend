      ...
      },
      {
        ...
        Cell: ({ row }) => (
          <div className=" action-button">
            {
              // (userInfo?.Action!=='Pending With Checker' ) && 
              <button
                title="Edit"
                style={{
                  border: "none",
                ...
                onClick={() => {
                  if (row?.original?.Status === 'Active' && row?.original?.Action === 'Pending With Checker') {

                  } else if (row?.original?.Status === 'Prematured' && row?.original?.Action === 'Pending With Checker') {

                  } else if (row?.original?.Status === 'Prematured' && row?.original?.Action === 'Approved') {
