...
const BGReportGrid = ({
    ...
    const downloadCSV = async () => {
        try {
            let url;
            if (!searchData?.Report_Name) {
                url = `${BASE_URL}user/DownloadBGReportData?BankName=${searchData?.Bank_Name}&Status=${searchData?.Status}&CompanyName=${searchData?.Entity_Name}&BGNo=${searchData?.Bg_No}&BGRefNo=${searchData?.BG_Ref_No}&EffectiveDate=${searchData?.From_Date}&ExpiryDate=${searchData?.To_Date}`;
            } else {
                url = `${BASE_URL}user/DownloadBGReportDataNameWise?BankName=${searchData?.Bank_Name}&Status=${searchData?.Status}&CompanyName=${searchData?.Entity_Name}&BGNo=${searchData?.Bg_No}&BGRefNo=${searchData?.BG_Ref_No}&EffectiveDate=${searchData?.From_Date}&ExpiryDate=${searchData?.To_Date}&BGReportName=${searchData?.Report_Name}`
            }
            // Create a temporary anchor element
            const link = document.createElement('a');
            link.href = url;
            // Set the download attribute with a default file name
            link.setAttribute('download', 'BG-Report.xlsx');
