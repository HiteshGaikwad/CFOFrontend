...
const TDSEntriesReportGrid = ({
    ...
    const columns = useMemo(
        ...
        () => [
            ...
            {
                Header: "Prematured ROI",
                accessor: "Prematured ROI",
                minWidth: 120,
            },
            {
                Header: "From Date",
            ...
            {
                Header: "Date of maturity / Premature Date",
                accessor: "Date of maturity / Premature Date",
                Cell: ({ value }) => value ? value.slice(0, 10) : '',
                minWidth: 150,
            },
            {
            ...
            {
                Header: "Actual Gross Int. Rcvd.",
                accessor: "Actual Gross Int. Rcvd.",
                minWidth: 150,
            },
            {
                Header: "Actual Int. Rcvd.",
                accessor: "Actual Int. Rcvd.",
                minWidth: 100,
            },
            {
                Header: "Date Of Receipt",
                accessor: "Date Of Receipt",
                minWidth: 100,
            },
            {
                Header: "Actual TDS",
    ...
    const downloadCSV = async () => {
        try {
            const url = `${BASE_URL}user/DownloadFDTDSReport?WhereClause=${WhereClauseStr}`;
            // Create a temporary anchor element
            const link = document.createElement('a');
            link.href = url;
            // Set the download attribute with a default file name
            link.setAttribute('download', 'TDS-Entries-Report.xlsx');
...
export default TDSEntriesReportGrid;
