...
const MFPTransactionSummeryReportGrid = ({
    tableData,
    ...
    const downloadCSV = async () => {
        try {
            ...
            const url = `${BASE_URL}user/DownloadMFTransactionSummaryReport?Type=${mfPledgeDetailsReport?.Type}&CompanyName=${mfPledgeDetailsReport?.Co_Name}&TypeOfInvestment=${mfPledgeDetailsReport?.Type_Of_Investment}&ISIN=${mfPledgeDetailsReport?.ISIN}&SchemeName=${mfPledgeDetailsReport?.Scheme_Name}&AsOnDate=${mfPledgeDetailsReport?.As_On_Date}`;
            // Create a temporary anchor element
            const link = document.createElement('a');
            link.href = url;
            // Set the download attribute with a default file name
            link.setAttribute('download', 'MF-Transaction-Summery-Report.xlsx');
...
export default MFPTransactionSummeryReportGrid;
