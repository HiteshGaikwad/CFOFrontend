...
import MFPTransactionSummeryReportGrid from "../../../Grids/TreasuryGrids/Reports/MFModule/MFTransactionSummeryReport";
...
const MFTransactionSummeryReport = (props) => {
    ...
    try {
      ...
      if (!flag) {
        const data = {
          ...
          CompanyName: mfPledgeDetailsReport?.Co_Name,
          TypeOfInvestment: mfPledgeDetailsReport?.Type_Of_Investment,
          ISIN: mfPledgeDetailsReport?.ISIN,
          SchemeName: mfPledgeDetailsReport?.Scheme_Name,
          AsOnDate: mfPledgeDetailsReport?.As_On_Date ? mfPledgeDetailsReport?.As_On_Date : d
        };
        const result = await RestfullApiService(
          data,
          "user/GetMFTransactionSummaryReportData"
        );
        console.log(result);
  ...
  const getCompanyNames = async () => {
    try {
      ...
      const result = await RestfullApiService(data, 'user/DDLGetTransactionSumaryCompany');
      const firstObj = {
        value: 0,
        label: 'All'
      }
  ...
  const getSchemeName = async () => {
    try {
      const data = {
        Type: mfPledgeDetailsReport?.Type,
        CompanyName: mfPledgeDetailsReport?.Co_Name !== '' ? mfPledgeDetailsReport?.Co_Name : 'ALL',
        TypeOfInvestment: mfPledgeDetailsReport?.Type_Of_Investment !== 'All' ? mfPledgeDetailsReport?.Type_Of_Investment : '0'
      }
      const result = await RestfullApiService(data, 'user/DDLGetTransactionSumaryscheme')
    ...
    <>
      <div className="panel">
        <div className="panel-hdr">
          <h2>MF Transaction Summery Report </h2>
          ...
          <div className="panel-content">
            <div className="row mt-2 mb-0 px-3" style={{ height: "80px" }}>
              ...
              <div className="col-lg-3 col-md-3  form-group mb-0">
                ...
                <ReactSelect
                  options={Type}
                  defaultValue={mfPledgeDetailsReport?.Type !== 'ALL' ? mfPledgeDetailsReport?.Type : Type[0]}
                  isClearable
              ...
              <div className="col-lg-3 col-md-3  form-group mb-0">
                ...
                <ReactSelect
                  options={companyName}
                  defaultValue={mfPledgeDetailsReport?.Co_Name !== 'ALL' ? mfPledgeDetailsReport?.Co_Name : companyName[0]}
                  isClearable
                  onChange={(selectedOption) => {
                    if (selectedOption) {
                      setMfPledgeDetailsReport({
        ...
        <div className="panel-container show px-3 fdReport">
          <div className="panel-content  fdReport">
            ...
            {isTableOpen && (
              <>
                <MFPTransactionSummeryReportGrid tableData={tableData} mfPledgeDetailsReport={mfPledgeDetailsReport} />
              </>
            )}
          </div></div>
      </div>
...
export default MFTransactionSummeryReport;
